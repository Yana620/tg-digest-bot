...
## Быстрый старт через Claude

Самый простой способ — скинь эту ссылку своему Claude и напиши:

> *"Помоги мне установить Telegram Claude Agent по инструкции из этого репозитория: https://github.com/Yana620/tg-digest-bot — веди меня пошагово, я буду выполнять каждый шаг и сообщать тебе результат"*

Claude сам проведёт тебя через весь процесс. Тебе нужно будет только:
1. Самостоятельно зайти на **my.telegram.org** и получить API ключи (Claude объяснит куда кликать)
2. Самостоятельно запустить `python3 setup.py` в терминале и ввести код из Telegram

Всё остальное Claude сделает вместе с тобой.
